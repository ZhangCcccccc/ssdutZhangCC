...
//取消查询
  function cancel()
  {
    window.location.href="${pageContext.request.contextPath}/asset/listAssetReceiveAudits?currpage=1&status=3";
  }
  //跳转
...
<body>
  ...
  <div class="content-box">
	...
	<div class="tool-box">
		<form:form name="queryForm" action="${pageContext.request.contextPath}/asset/listAssetReceiveAudits?currpage=1&status=9" method="post" modelAttribute="assetReceive">
			  <ul>
  				<li>申请编号： </li>
  				<li>
