            	...
            	<tr>
                    ...
                    <td>
                        <div class="equipment_box">
                            <div class="equipment_name">${labRoomDevice.schoolDevice.deviceName}[${labRoomDevice.schoolDevice.deviceNumber}]</div>
                            <ul class="equipment_introduce">
                                ...
                                <li><span>所在实验室:</span>${labRoomDevice.labRoom.labRoomName}</li>
                                <li><span>设备管理员:</span>
                                ...
                                <%-- <li><span>状态:</span>${labRoomDevice.CDictionaryByDeviceStatus.name}</li> --%>
                                <li><span>状态:</span>${labRoomDevice.CDictionaryByDeviceStatus.CName}</li>
                                <li><span>所在地点:</span>${labRoomDevice.labRoom.systemRoom.systemBuild.systemCampus.campusName}
                                ${labRoomDevice.labRoom.systemRoom.systemBuild.buildName}
                            ...
                            <div>
								...
								<a class="btn btn-new" onclick="viewDeviceInfoRest(${labRoomDevice.id})" href="#"  title="查看">查看</a>
                        		<sec:authorize ifAnyGranted="ROLE_SUPERADMIN,ROLE_TEACHER,ROLE_EXPERIMENTALTEACHING,ROLE_PREEXTEACHING,ROLE_EXCENTERDIRECTOR,ROLE_LABMANAGER,ROLE_EQUIPMENTADMIN,ROLE_STUDENT">
                       			<c:if test="${labRoomDevice.CDictionaryByAllowSecurityAccess.CNumber == 1}">
                                <sec:authorize ifAnyGranted="ROLE_SUPERADMIN,ROLE_EQUIPMENTADMIN">
                                <a class="btn btn-new" href="#" onclick="editDeviceTrainingRest(${labRoomDevice.id})";>培训申请</a>
                                </sec:authorize>
                                <sec:authorize ifAnyGranted="ROLE_STUDENT,ROLE_TEACHER"> 
                                <sec:authorize ifNotGranted="ROLE_SUPERADMIN,ROLE_EQUIPMENTADMIN">
                                <a class="btn btn-new" href="#" onclick="viewDeviceTrainingRest(${labRoomDevice.id})";>培训申请</a>
                                </sec:authorize> 
                                </sec:authorize>
                                </c:if>
                                </sec:authorize>
                              ...
                              <a class="btn btn-new" target="_blank" href="${pageContext.request.contextPath}/device/listInnerSameDevice?deviceId=${labRoomDevice.id}">关联设备</a>
                              </sec:authorize>
                                <sec:authorize ifAnyGranted="ROLE_SUPERADMIN,ROLE_EXPERIMENTALTEACHING,ROLE_PREEXTEACHING,ROLE_EXCENTERDIRECTOR">
                        		<a class="btn btn-new" href="#" onclick="openSetupLink(${labRoomDevice.id})" title="设置">设置</a>
                        		</sec:authorize>
