...
<ul>
	...
	<li class="end"><a href="javascript:void(0)">门禁进出记录</a></li>
...
<tbody >
	...
	<td><p> <a class="classroom-name" href="${pageContext.request.contextPath}/labRoom/appointment/showLabRoom?id=${room.id}">${room.labRoomName}${room.labRoomAddress }</a></p></td>
