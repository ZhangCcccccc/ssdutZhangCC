...
<html>
	...
	src="${pageContext.request.contextPath}/js/operation/newoperationoutlineAudit.js"></script>
	...
	<body>
		<div id="bgheight">
			...
			<div class="list_chose">
				<div class="list_chose_div all_btn selected_btn">全部审核</div>
				<div class="list_chose_div my_btn">我的审核</div>
			</div>
			<div class="all_main_content">
				<div class="all_div">
					<div class="gray_line">
							<form:form name="form"
								action="${pageContext.request.contextPath}/newoperation/experimentalAudit?currpage=1"
					...
					<div class="bgwo w100p ptb10">
						<table class="experimental_list_tab" cellspacing="0">
							...
							<c:forEach items="${Outlinelist}" varStatus="i" var="s">
								...
								<a class="fa fa-search blue" title="查看详情" href="${pageContext.request.contextPath}/newoperation/viewOperationOutline?idkey=${s.id}&from=3&page=${currpage}"></a>
						...
						<div class="page-select">
							...
							<form>
							   ...
							   <option value="${pageContext.request.contextPath}/newoperation/experimentalAudit?currpage=${currpage}">${currpage}</option>
							   <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">	
					           <c:if test="${j.index!=currpage}">
					           <option value="${pageContext.request.contextPath}/newoperation/experimentalAudit?currpage=${j.index}">${j.index}</option>
					           </c:if>
					           </c:forEach>
					           </select>
							</form>
