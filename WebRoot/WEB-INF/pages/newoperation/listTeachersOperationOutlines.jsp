	...
	<body>
		<div id="bgheight">
			...
			<div class="all_main_content">
				<div class="gray_line">
				<form:form name="form"
								action="${pageContext.request.contextPath}/newoperation/listTeachersOperationOutlines?currpage=1"
				...
				<div class="page-message">
						...
						<div class="page-select">
							...
							<form>
							   ...
							   <option value="${pageContext.request.contextPath}/newoperation/listTeachersOperationOutlines?currpage=${currpage}">${currpage}</option>
							   <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">	
					           <c:if test="${j.index!=currpage}">
					           <option value="${pageContext.request.contextPath}/newoperation/listTeachersOperationOutlines?currpage=${j.index}">${j.index}</option>
					           </c:if>
					           </c:forEach>
					           </select>
							</form>
		...
		<script type="text/javascript">
			...
			function cancel(){
  				window.location.href="${pageContext.request.contextPath}/newoperation/listTeachersOperationOutlines?currpage=1";
			}
		//首页
function first(){
	document.form.action="listTeachersOperationOutlines?currpage=1";
...
function previous(){
    ...
    document.form.action="listTeachersOperationOutlines?currpage="+page;
    document.form.submit();
}
