	...
	<body>
		<div id="bgheight">
			...
			<div class="all_main_content ovh">
				<div class="w74p l">
					<div class="gray_line">
						<form name="form"
								action="${pageContext.request.contextPath}/newtimetable/doMergeCourseTimetablePublic?mergeId=${mergeId}"
								method="post">
				...
				<div class="w25p r message_container">
						...
						<div class="track_detail">
							<div class="course_method cf" style="width:90%;height:auto;">
								<form>
									...
									<div class="l">
										<input type="radio" class="teacher_course"   checked="checked" name="course_method" onclick="changeStyle(7)"/>
										<span>公选排课</span>
									</div>
								</form>
							</div>
					...
					<div class="public_message">
						<div class="pub_tit">
							<div class="l">
								<span class="b">${schoolCourseMerge.courseName }<span class="r1 ml10">${schoolCourseMerge.studentNumbers}</span>人</span>
						...
						<div class="track_detail">
							<div class="course_method" style="width:90%">
								<form>
									...
									<div class="l">
										<input type="radio"   checked="checked" class="teacher_course" name="course_method" onclick="changeStyle(7)"/>
										<span>公选排课</span>
									</div>
								</form>
							</div>
		...
		<script type="text/javascript">
				...
				function(e) {
						if($(e.target).hasClass("choose_this")){
						 ...
						 var s = id.split("-");
		            	         ...
		            	         $.ajax({
		            	            url:"${pageContext.request.contextPath}/newtimetable/saveSinglePublicElectiveCourseTimetableInMerge?mergeId=${mergeId}",
		            	            type:'POST',
			...
			function doPublicElectiveCourseTimetable(){
				...
				$.ajax({
			         url:"${pageContext.request.contextPath}/newtimetable/savePublicElectiveCourseTimetable?mergeId=${mergeId}",
			         dataType:"json",
			         type:'GET',
			...
			var weeks = new Array();
				...
				$.ajax({
			         url:"${pageContext.request.contextPath}/newtimetable/savePublicElectiveCourseTimetableInMerge?mergeId=${mergeId}",
			         dataType:"json",
			         type:'GET',
			         data:{term:${schoolTerm.id},weeks:weeks.join(","), weekdays:weekdays.join(","),classes:classes.join(","),labRoom:${roomId}
			         ,courseStartTime:courseStartTime,courseEndMinute:courseEndMinute, withdrawalMinute:withdrawalMinute
