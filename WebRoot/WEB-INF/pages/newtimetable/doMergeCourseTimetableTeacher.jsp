...
<html>
	...
	<body>
		<div id="bgheight">
			...
			<form name="form"
								action="${pageContext.request.contextPath}/newtimetable/doMergeCourseTimetableTeacher?mergeId=${mergeId}"
								method="post">
				...
				<div class="w25p r message_container">
					<div class="public_message">
						<div class="pub_tit">
							...
							<c:if test="${isPartComplete eq 1 }">
								<button class="r" type="button" onclick="sendMessageByBacth('${mergeId}',${batchId})">发送消息</button>
							</c:if>
							<c:if test="${isPartComplete ne 1 }">
						...
						<div class="track_detail">
							<div class="course_method cf" style="width:90%;height:auto;">
								<form>
									...
									<div class="l">
										<input type="radio"  checked="checked"  class="teacher_course" name="course_method" onclick="changeStyle(5)"/>
										<span>教师强排</span>
									</div>
									<div class="l">
							...
							<div class="student_select">
								...
								<c:if test="${group.timetableStyle == 25}">
								<div class="course_select cf" id="course_select${group.id }">
									<div>
										...
										<span>人数：</span>
										<input type="text" class="check_text" id="total${group.id }" value="${group.numbers}" readonly/>
		...
		// 学生判冲
		 function generateConflict(){
			...
			function cancel(){
				window.location.href = "${pageContext.request.contextPath}/newtimetable/doMergeCourseTimetableTeacher?mergeId=${mergeId}";
			}
