	...
	<body>
		<div id="bgheight">
			...
			<div class="all_main_content ovh">
				<div class="w74p l">
					<div class="gray_line">
						<form name="form"
								action="${pageContext.request.contextPath}/newtimetable/doPublicElectiveCourseTimetable?courseDetailNo=${courseDetailNo}"
								method="post">
		...
		<script type="text/javascript">
			...
			function chooseThis(week,weekday,classes){
				...
				$div.append($span4);
				$div.append($i);
				var $divNew = $("<div class='course_select'></div>");
				$divNew.append($div)
						...
						if($(e.target).hasClass("choose_this")){
						 ...
						 var s = id.split("-");
		            	         ...
		            	         $.ajax({
		            	            ...
		            	            type:'POST',
		            	            data:{term:${schoolTerm.id},week:s[0], weekday:s[1],selectClass:s[2],labRoom:${labRoom.id}},
						         ...
						         success:function(result)
						         {
						         	if(result == "-1")
						            {
										...
										$div.append($weekday);
										$div.append($classes);
										var $divNew = $("<div class='course_select sample' id='d"+id+"'></div>");
										$divNew.append($div)
			...
			function doPublicElectiveCourseTimetable(){
				...
				$.ajax({
			         ...
			         dataType:"json",
			         type:'GET',
			         data:{term:${schoolTerm.id},weeks:weeks.join(","), weekdays:weekdays.join(","),classes:classes.join(","),labRoom:${labRoom.id}
