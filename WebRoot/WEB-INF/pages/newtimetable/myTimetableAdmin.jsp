...
<html>
	...
	<body>
		...
		<script type="text/javascript">
			...
			function cancel(){
				window.location.href = "${pageContext.request.contextPath}/newtimetable/myTimetableAdmin";
			}
			...
			function query(){
				document.form.action="${pageContext.request.contextPath}/newtimetable/myTimetableAdmin";
				document.form.submit();
			}
