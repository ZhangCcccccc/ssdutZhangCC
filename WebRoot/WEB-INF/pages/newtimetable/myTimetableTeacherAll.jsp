	...
	<body>
		<div id="bgheight">
			...
			<div class="all_main_content">
				<div class="gray_line">
				<form name="form" action="${pageContext.request.contextPath}/newtimetable/myTimetableTeacherAll" method="post">
					...
					<table>
						<tr>
							<td>
								...
								<button>取消</button>
								<a href="${pageContext.request.contextPath}/newtimetable/myTimetableTeacher"><button>返回</button></a>
							</td>
						</tr>
					</table>
					</form>
