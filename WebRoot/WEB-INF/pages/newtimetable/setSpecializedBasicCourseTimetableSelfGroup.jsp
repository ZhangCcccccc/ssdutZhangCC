	...
	<body>
			...
			<div class="all_main_content ovh">
				<div class="w74p l">
					<div class="normal">
						...
						<div id="newCourseCode" style="background-color: white;"></div>
					...
					<div class="public_message">
						...
						<div class="track_detail">
							...
							<div class="student_select">
								...
								<div>
									<button class="r mt5 mb10 mr5p" type="button" onclick="doSpecializedBasicCourseTimetableSelf()">自动分批</button>
									<button class="r mt5 mb10 mr5p" type="button" onclick="doSpecializedBasicCourseTimetableHand()">手动分批</button>
								</div>
								</div>
							</div>
						</div>
		...
		var selectGroup = -1;
		 ...
		 if($("#groupId").val() != null && $("#groupId").val() != ""){
			...
			function doSpecializedBasicCourseTimetableSelf(){
				if($("#groupNumbers").val() != "" && $("#groupNumbers").val() != null){
					document.form.action = "${pageContext.request.contextPath}/newtimetable/setSpecializedBasicCourseTimetableSelfGroup?courseDetailNo=${courseDetailNo}";
					document.form.submit()
				}
				else{
					alert("请填写批数！");
			...
			function doSpecializedBasicCourseTimetableHand(){
				if($("#groupNumbers").val() != "" && $("#groupNumbers").val() != null){
						  layer.ready(function(){
						        layer.open({
						            ...
						            content:'${pageContext.request.contextPath}/newtimetable/inBatches?timetableBatchId=999999&courseDetailNo=${courseDetailNo}&groupNumbers='+$("#groupNumbers").val()+"&item="+${item},
						            end: function(){
