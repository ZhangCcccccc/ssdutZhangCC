...
<head>
	...
	<c:forEach items="${labAdminRates}" var="curr" varStatus="i">
	    <c:choose>
...
function search()
{
	...
	if(terms != null)
	{
		document.queryForm.action="${pageContext.request.contextPath}/report/reportLabAdminRate";
...
<div class="title">
  <div id="title">报表统计--实验室专职管理人员人均接待师生人时数</div>
</div> 
<div class="tool-box">
...
<br />
<div style="text-align:center;"><b>专职管理人员人均接待师生人时数=实验人时数 / 专职管理人员数</b></div>
<br />
...
<tbody>
  <c:forEach items="${labAdminRates}" var="current" varStatus="i">
  <tr>
  	<td>${current.labRoomName}</td>
  	<td><a style="color:#0000ff;" href="${pageContext.request.contextPath}/report/reportStudentTime?currpage=1&academyNumber=${current.labRoomPhone}&terms=${labRoom.labRoomName}">${current.labRoomAddress}</a></td>
