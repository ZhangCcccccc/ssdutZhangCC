...
<div id="TabbedPanels1" class="TabbedPanels">
 ...
 <form:form id="form1" method="POST" modelAttribute="time">
   <table>
    <tr>
     <th>节次名字<font color=red>*</font></th>
			...
			<form:input type="hidden" id="campusNumber" path="systemCampus.campusNumber" value="${campusNumber}"/>
			</td>
   ...
   <th>结束时间<font color=red>*</font></th>
    ...
    <form:option value="${cmp.campusNumber}">${cmp.campusName}</form:option>
    </form:select>
    </td> --%>
...
<%--     <tr>
    ...
    <div class="moudle_footer">
        <div class="submit_link">
            <input type="submit" value="提交" onclick="saveTime();" class="alt_btn" >
