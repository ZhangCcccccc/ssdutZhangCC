    ...
    <div class="course_con ma back_gray">
        <div class="course_cont r back_gray">
            ...
            <div class="tab_list f14 mb2">
              ...
              <a href="${pageContext.request.contextPath}/tcoursesite/experimentAchievement?currpage=1&tCourseSiteId=${tCourseSite.id }&type=experiment">首页</a>			    
	          <a href="${pageContext.request.contextPath}/tcoursesite/experimentAchievement?currpage=${pageModel.previousPage}&tCourseSiteId=${tCourseSite.id }&type=experiment">上一页</a>
	                                 第<select onchange="javascript:window.location.href = this.options[this.selectedIndex].value;">
	          <option value="${pageContext.request.contextPath}/tcoursesite/experimentAchievement?currpage=${pageModel.currpage}&tCourseSiteId=${tCourseSite.id }&type=experiment">${pageModel.currpage}</option>
	          <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">	
              <c:if test="${j.index!=pageModel.currpage}">
              <option value="${pageContext.request.contextPath}/tcoursesite/experimentAchievement?currpage=${j.index}&tCourseSiteId=${tCourseSite.id }&type=experiment">${j.index}</option>
              </c:if>
              </c:forEach></select>页
	          <a href="${pageContext.request.contextPath}/tcoursesite/experimentAchievement?currpage=${pageModel.nextPage}&tCourseSiteId=${tCourseSite.id }&type=experiment">下一页</a>
 	          <a href="${pageContext.request.contextPath}/tcoursesite/experimentAchievement?currpage=${pageModel.lastPage}&tCourseSiteId=${tCourseSite.id }&type=experiment">末页</a>
              </div>
