        ...
        <div class="course_cont r back_gray">
            <div class="course_infobox">
                ...
                <div class="course_schedule">
                    ...
                    <p class="f16">( ${skillDoList[0]+1}/${fn:length(tExperimentSkills)})</p>
                </div>
            </div>
            <div class="course_content">
                <div class="f_right lab_item_ctrl">
                	<a class="btn_lab btn_blue" href="${pageContext.request.contextPath}/tcoursesite/skill/gradeAllExperimentSkill?tCourseSiteId=${tCourseSite.id}" >所有实验分数</a><%--
                    ...
                    <a class="btn_lab btn_blue" href="javascript:void(0)" onclick="editExperiment(-1)">新建实验项目</a>
                    </c:if>          
                </div>
                <div class="exp_list">
                    实验列表
                    ...
                    <div class="lab_item">
                        ...
                        --%><div class="f_right lab_item_ctrl">
                           ...
                           <a class="btn_lab btn_green" href="#">开始实验</a>
                            --%><a class="btn_lab btn_blue" href="${pageContext.request.contextPath}/tcoursesite/skill/workExperimentSkill?tCourseSiteId=${tCourseSite.id}&skillId=${experiment.id}&moduleType=${moduleType }&selectId=${selectId}">实验作业</a>
                             <c:if test="${sessionScope.authorityName eq 'TEACHER' or sessionScope.authorityName eq 'COURSETEACHER' || sessionScope.authorityName eq 'SUPERADMIN' || sessionScope.authorityName eq 'LABCENTERMANAGER'}">
                             <a class="btn_lab btn_blue" href="${pageContext.request.contextPath}/tcoursesite/skill/deleteExperimentSkill?tCourseSiteId=${tCourseSite.id}&skillId=${experiment.id}&moduleType=${moduleType }&selectId=${selectId}">删除实验项目</a>
                             </c:if>
                        </div>
                    </div>
                    </c:forEach>
