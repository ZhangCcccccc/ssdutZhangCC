    ...
    <div class="header_bg">
        <div class="header">
            ...
            <ul class="menu_container">
                <li>
                    <a href="/xidlims/self/myCenter">首页</a>
                </li>
        		...
        		<div class="tool-box">
					<form:form name="queryForm" action="${pageContext.request.contextPath}${url}?currpage=1" method="post" modelAttribute="tCourseSite">
					   	<ul>
					    	...
					    	<li>
					    		<input type="button" value="视频批量生成二维码" onclick="batchMadeQRCode();"/>
					    	</li>
						</ul>
					</form:form>
			   </div>
		                ...
		                <li>
		                    <div class="courses_box">
		                        ...
		                        <div class="courses_intro_tit">
		                            <a href="javascript:void(0);" onclick="checkLogin('${user}',${site.id});" target="self">
            		...
            		<c:if test="${str!=null }">
            			...
            			<div class="form_title">
                         ...
                         <div class="form_title">
            			  ...
            			  <div class="form_title">
            			     <label>专业:</label>
            			   <span>${user.schoolAcademy.academyName}</span>
            			</div>
            			   <div class="form_title">
            			     <label>学院/部门:</label>
            			   <span>${str}</span>
...
<%--             			<table align="center"> 
												...
												<div class="tool-box">
													<table>
														...
														<tr>
															...
															<td><form:input id="qq"  path="qq" class="easyui-numberbox" placeholder="仅可输入数字" /> </td>
														</tr>
													</table>
												</div>
        ...
        <script type="text/javascript">
        function checkLogin(uesr,id){
        	if(uesr){
        		window.location.href="${pageContext.request.contextPath}/tcoursesite?tCourseSiteId="+id;
        	}else{
                $(".log-in").show();
        	}
        }
    ...
    function batchMadeQRCode(){
    	$.ajax({
    		type: "POST",
    		url: $("#contextPath").val()+"/tcoursesite/batchMadeQRCode",
    		dataType:'text',
