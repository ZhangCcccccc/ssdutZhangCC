...
(function(){
	...
	function insertLocalVideo(){
        var url=document.getElementById("content_contentField_flv").value;
       //alert(flvurl);
        var current=editor.getContent();
       //alert("现在editor的内容"+current);
        editor.enable();
        editor.setContent(current+url);       
        //alert("现在editor的内容"+editor5.value);              
	}
